...
|  |  |__   |  |  | | | |  version 2.0.0
|_____|_____|_____|_|___|  https://github.com/libjson/json

Copyright (c) 2013-2016 Niels Lohmann <http://libjson.me>.
...
#include <utility>
#include <vector>
#include <../../libaulstring/include/std_string_convert.hpp>
   ...
   */
   ...
   private:
      ...
      */
                 ...
                 const unsigned int current_indent = 0 ) const
      {
         ...
         auto ts = string_t{};
         auto fn_proc_indent = [ & ] ( auto ni )->string_t
         {
            ts.clear( );
            ts.resize( ni );
   ...
   private:
      ...
      */
      ...
      https://github.com/libjson/json/pull/105.
      */
               ...
               if( *i == '\\' )
               {
                  ...
                  switch( *i )
                  {
                     ...
                     case 'u':
                     {
                        ...
                        auto codepoint = strtoul( string_t( reinterpret_cast< typename string_t::const_pointer >( i + 1 ),
                                                  4 ).c_str( ), nullptr, 16 );
                        ...
                        if( codepoint >= 0xD800 and codepoint <= 0xDBFF )
                        {
                           ...
                           auto codepoint2 = strtoul( string_t( reinterpret_cast< typename string_t::const_pointer >
         ...
         */
         void get_number( basic_json& result ) const
         {
            ...
            if( *reinterpret_cast< typename string_t::const_pointer >( m_start ) != '-' )
            {
               ...
               // number_unsigned_t
               if( attempt_cast( strtoull( reinterpret_cast< typename string_t::const_pointer >( m_start ),
                   &endptr,
            ...
            else
            {
               ...
               // number_integer_t
               if( attempt_cast( strtoll( reinterpret_cast< typename string_t::const_pointer >( m_start ),
                   &endptr,
...
namespace std
{
   ...
   */
   template <>
   inline void swap( libjson::json& j1,
                     libjson::json& j2 ) noexcept(
      is_nothrow_move_constructible<libjson::json>::value and
      is_nothrow_move_assignable<libjson::json>::value
      )
   {
      j1.swap( j2 );
   }
   ...
   struct hash<libjson::json>
   {
      ...
      @since version 1.0.0
      */
      std::size_t operator()( const libjson::json& j ) const
      {
         // a naive hashing via the string representation
         const auto& h = hash<libjson::json::string_t>( );
         return h( j.dump( ) );
      }
   };
}
...
@since version 1.0.0
*/
inline libjson::json operator "" _json( const char* s, std::size_t )
{
   return libjson::json::parse( reinterpret_cast< const libjson::json::string_t::value_type* >( s ) );
}
